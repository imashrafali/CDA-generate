    ...
    <body>
        <%
            ...
            if (session.getAttribute("keyRecover") != null) {
                keyRecovers = session.getAttribute("keyRecover").toString();
            }
        %>
        <div class="wrap-body">
            ...
            <section id="container">
                <div class="wrap-container">
                    <div class="zerogrid">
                        <div>
                            <center><h2 style="color: blue;"><%=keyRecovers%></h2><% session.removeAttribute("keyRecovers");%></center>
                            <div class="wrap-col">
                                <div class="contact">
                                    <center> <h3>Patient Report</h3> 
                                        <div>
                                            <table style="width: 80%; border: 2px solid menutext; ">
                                                <tr style="border: 2px solid menutext; "><th style="border: 2px solid menutext; ">Physician-ID</th><th style="border: 2px solid menutext; ">Physician Name</th><th style="border: 2px solid menutext; ">Physician Email-ID</th><th style="border: 2px solid menutext;">Physician Contact No.</th> <th style="border: 2px solid menutext; ">Physician State</th><th style="border: 2px solid menutext; ">Physician country</th><th style="border: 2px solid menutext;">Patient-ID</th><th style="border: 2px solid menutext; ">Patient Name</th><th style="border: 2px solid menutext; ">Patient Email-ID</th><th style="border: 2px solid menutext; ">Patient DOB</th><th style="border: 2px solid menutext; ">Request User</th><th style="border: 2px solid menutext; ">Approve Request</th> </tr>

                                                <%
                                                    DBQuery dbq = new DBQuery();
                                                    ResultSet rs = dbq.physicianRequest("Physician");
                                                    while (rs.next()) {
