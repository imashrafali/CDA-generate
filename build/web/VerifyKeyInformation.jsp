                                        ...
                                        <div id="contact_form">
                                            <form name="form1" id="ff" method="post" action="PatientInfoA">
                                                <label class="row">
                                                    ...
                                                    <div class="col-1-2">
                                                        <div class="wrap-col">
                                                       Email: <input type="text" name="pName" id="email" value="<%=pName%>"  />
                                                        </div>
                                                    </div>
                                                </label>
                                                <label class="row">
                                                    ...
                                                    <div class="col-1-2">
                                                        <div class="wrap-col">
                                                       Patient ID: <input type="text" name="pAge" id="email" value="<%=pAge%>"  />
                                                        </div>
                                                    </div>
                                                </label>
                                                <label class="row">
                                                ...
                                                <center> <h3>Doctor Information</h3>
                                                    ...
                                                    <center> <h3>Clinical Information</h3>
                                                        <label class="row">
                                                            ...
                                                            <div class="col-1-2">
                                                                <div class="wrap-col">
                                                                  Reason For Visit: <input type="text" name="Resion" id="email" value="<%=Resion%>"  />
                                                                </div>
                                                            </div>
                                                        </label>
                                                        <label class="row">
                                                            ...
                                                            <div class="col-1-2">
                                                                <div class="wrap-col">
                                                               immunizations: <input type="text" name="immunization" id="email" value="<%=immunization%>"  />
                                                                </div>
                                                            </div>
                                                            <label class="row">
                                                                <div class="col-1-2">
                                                                    <div class="wrap-col">
                                                                     Problem: <input type="text" name="Problem" id="Problem" value="<%=Problem%>"  />
                                                                    </div>
                                                                </div>
                                                                <div class="col-1-2">
                                                                    <div class="wrap-col">
                                                            ...
                                                            <label class="row">
                                                                <div class="col-1-2">
                                                                    <div class="wrap-col">
                                                                      Hospital: <input type="text" name="hospital" id="name" value="<%=hospital%>"  />
                                                                    </div>
                                                                </div>
                                                                <div class="col-1-2">
                                                                    <div class="wrap-col">
