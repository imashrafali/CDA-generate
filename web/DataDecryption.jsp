...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        <%            
            String fileValue = "";
            if (session.getAttribute("filess") != null) {
                fileValue = session.getAttribute("filess").toString();
                
            }
            
            String encData = "";
            if (session.getAttribute("encData") != null) {
                encData = session.getAttribute("encData").toString();
                            ...
                            <div class="wrap-col">
                                <div class="contact">
                                    ...
                                    <div class="contact">
                                        ...
                                        <div id="contact_form">
                                            <center>      <h4>Encrypted Data</h4>  </center>
                                            <center>  <form name="form1" id="ff" method="post" action="DecryptionFile">
                                                    <center>   <label class="row">
                                                            <div class="col-1-2">
                                                                <div class="wrap-col" style="overflow-x:auto;">
                                                                    <textarea rows="8" cols="80" name="fileData"></textarea>
                                                                </div>
                                            ...
                                            <center>      <h4>Decrypted Data</h4>   </center>  
                                            <center>    <form name="form1" id="ff" method="post" action="">
                                                    <center>       <label class="row">
                                                            <div class="col-1-2">
                                                                <div class="wrap-col" style="overflow-x:auto;">
                                                                    <textarea rows="8" cols="80" name="fileData"><%=encData%></textarea>
                                                                </div>
