...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        <%
            String PhRegistration = "";
            if (session.getAttribute("PhRegistration") != null) {
                PhRegistration = session.getAttribute("PhRegistration").toString();
            }
        ...
        <div class="wrap-body">
            ...
            <section id="container">
                <div class="wrap-container">
                    <div class="zerogrid">
                        <center>  <h4 style="color: blue;"><%=PhRegistration%></h4><% session.removeAttribute("PhRegistration");%></center>
                        <div class="col-2-3">
                            <div class="wrap-col">
                                <div class="contact">
                                    <center> <h3>Physician Registration</h3>
                                        <div id="contact_form">
                                            <form name="form1" id="ff" method="post" action="PhysicianRegistration">
                                                <label class="row">
                                                    <div class="col-1-2">
                                                        <div class="wrap-col">
                                                            <input type="text" name="phyId" id="name" placeholder="Doctor-ID" required="required" />
                                                        </div>
                                                    </div>
                                                ...
                                                <label class="row">
                                                    <div class="col-1-2">
                                                        <div class="wrap-col">
                                                            <input type="text" name="password" id="name" placeholder="Password" required="required" />
                                                        </div>
                                                    </div>
