...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        <%
            String PatientInfoA = "";
            if (session.getAttribute("PatientInfoA") != null) {
                PatientInfoA = session.getAttribute("PatientInfoA").toString();
            }
        ...
        <div class="wrap-body">
            ...
            <section id="container">
                <div class="wrap-container">
                    <div class="zerogrid">
                        <center>  <h4 style="color: blue;"><%=PatientInfoA%></h4><% session.removeAttribute("PatientInfoA");%></center>
                        <div class="col-2-3">
                            <div class="wrap-col">
                                <div class="contact">
                                            ...
                                            <form name="form1" id="ff" method="post" action="PatientInfoA">
                                                ...
                                                <center> <h3>Doctor Information</h3>
                                                    ...
                                                    <center> <h3>Clinical Information</h3>
                                                        ...
                                                        <input type="hidden" name="hospitalA" value="hospitalA"/>
                                                        <input type="hidden" name="emailA" value="raviprakashsingh146@gmail.com"/>
