...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        <%
            String FileRequestB = "";
            if (session.getAttribute("FileRequestB") != null) {
                FileRequestB = session.getAttribute("FileRequestB").toString();
            }
        ...
        <div class="wrap-body">
            ...
            <section id="container">
                <div class="wrap-container">
                    <div class="zerogrid">
                        <div>
                            <center>  <h4 style="color: blue;"><%=FileRequestB%></h4><% session.removeAttribute("FileRequestB");%></center>
                            <div class="wrap-col">
                                <div class="contact">
                                            ...
                                            <table style="width: 80%; border: 2px solid menutext; ">
                                                ...
                                                <tr style="border: 2px solid menutext; "><td style="border: 2px solid menutext; "><%=pid%></td><td style="border: 2px solid menutext; "><%=pName%></td><td><%=pEmail%></td><td style="border: 2px solid menutext; "><%=date%></td>
                                                    <td style="border: 2px solid menutext; ">
                                                        <form method="post" action="fileRequestHosB">
