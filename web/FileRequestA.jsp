...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body>
        <%
            String FileRequestA = "";
            if (session.getAttribute("FileRequestA") != null) {
                FileRequestA = session.getAttribute("FileRequestA").toString();
            }
        ...
        <div class="wrap-body">
                ...
                <div class="zerogrid">
                    ...
                    <nav id="menu-wrap"><div id="menu-trigger">Menu</div>    
                        <ul id="menu" style="display: none;">
                            <li><a href="HospitalAHome.jsp">Home</a></li>
                            <li><a href="ReportUploadA.jsp">Report Upload</a></li>
                            <li><a href="ViewReportA.jsp">View Report</a></li>
                            <li><a href="FileRequestA.jsp">File Request</a></li>
            ...
            <section id="container">
                <div class="wrap-container">
                    <div class="zerogrid">
                        <div>
                            <center>  <h4 style="color: blue;"><%=FileRequestA%></h4><% session.removeAttribute("FileRequestA");%></center>
                            <div class="wrap-col">
                                <div class="contact">
                                    <center> <h3>Patient Report</h3> 
                                        <div id="contact_form">
                                            <table style="width: 80%; border: 2px solid menutext; ">
                                                <tr style="border: 2px solid menutext; "><th style="border: 2px solid menutext; ">Patient-ID</th><th style="border: 2px solid menutext; ">Patient Name</th><th style="border: 2px solid menutext; ">Patient Email-ID</th><th style="border: 2px solid menutext;">Date Of Birth</th> <th style="border: 2px solid menutext; ">View</th> </tr>

                                                <%
                                                    String hospitalA = "hospitalA";
                                                    DBQuery dbq = new DBQuery();
                                                    ResultSet rs = dbq.patientDetails(hospitalA);
                                                    while (rs.next()) {
                                                ...
                                                <tr style="border: 2px solid menutext; "><td style="border: 2px solid menutext; "><%=pid%></td><td style="border: 2px solid menutext; "><%=pName%></td><td><%=pEmail%></td><td style="border: 2px solid menutext; "><%=date%></td>
                                                    <td style="border: 2px solid menutext; ">
                                                        <form method="post" action="fileRequestHosA">
                                                            <input type="hidden" name="pid" value="<%=pid%>">
                                                            <input type="hidden" name="pName" value="<%=pName%>">
                                                            <input type="hidden" name="pEmail" value="<%=pEmail%>">
                                                            <input type="hidden" name="date" value="<%=date%>">
                                                            <input type="submit"  value="Request" style="width: 60px; background-color: aliceblue; color: darkviolet;"> 
                                                        </form>
